...
function getMetricRequest(intent, session, response) {
    ...
    if (metric === "game log" || metric === "season stats") {
        if ((metric === "season stats") && (week)) {
            speechOutput = {
